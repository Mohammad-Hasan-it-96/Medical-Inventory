                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0"
                               ...
                               id="net_price_syp" name="net_price_syp" value="{{ old('net_price_syp', 0) }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0"
                               ...
                               id="public_price_syp" name="public_price_syp" value="{{ old('public_price_syp', 0) }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('form') is-invalid @enderror" id="form" name="form">
                            ...
                            @foreach(['tablet','capsule','syrup','injection','cream','ointment','drops','spray','powder','gel','solution','suspension','other'] as $f)
                                <option value="{{ $f }}" {{ old('form') === $f ? 'selected' : '' }}>
