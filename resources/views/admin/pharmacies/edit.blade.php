@extends('layouts.app')
@section('title', __('pharmacies.edit') . ' – ' . $pharmacy->name)
@section('content')
<div class="container-fluid">
    <div class="d-flex align-items-center gap-2 mb-4">
        ...
        <h3 class="mb-0">
            <i class="bi bi-hospital me-2"></i>{{ __('pharmacies.edit') }}:
            <span class="fw-normal">{{ $pharmacy->name }}</span>
        </h3>
    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="rep_id" class="form-select @error('rep_id') is-invalid @enderror">
                            ...
                            @foreach($reps as $rep)
                                <option value="{{ $rep->id }}"
                                    {{ old('rep_id', $pharmacy->rep_id) == $rep->id ? 'selected' : '' }}>
                                    {{ $rep->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" min="0" name="credit_limit"
                                   ...
                                   value="{{ old('credit_limit', $pharmacy->credit_limit) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" name="opening_balance"
                                   ...
                                   value="{{ old('opening_balance', $pharmacy->opening_balance) }}">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="notes" rows="2"
                                  class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $pharmacy->notes) }}</textarea>
                    ...
                    <div class="col-12 mt-2 d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save me-1"></i>{{ __('pharmacies.buttons.update') }}
                        </button>
                        <a href="{{ route('admin.pharmacies.show', $pharmacy) }}" class="btn btn-outline-info">
                            <i class="bi bi-eye me-1"></i>{{ __('pharmacies.buttons.view') }}
                        </a>
